        ...
        >
          ...
          <div class="sm:px-0 px-4">
            ...
            <div class="full_flex sm:mt-14 mt-10 pb-[60px]">
              ...
              <button
                v-else-if="isLoading.user.data.current_role == 'main_teacher'"
                @click="
                  nextPage(
...
function nextPage(lesson_id, type) {
  ...
  if (type == "create_test") {
    ...
    url = "/" + path[1] + "/" + path[2] + "/" + path[3] + "/" + lesson_id;
    url += "?class=" + router.currentRoute.value.query.class;
  }
  router.push(url);
}
...
function createLesson() {
  ...
  url +=
    "?class=" + router.currentRoute.value.query.class + "&create_lesson=true";
  router.push(url);
}
